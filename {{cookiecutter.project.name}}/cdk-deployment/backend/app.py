...
from {{cookiecutter.service_name|replace(' ', '')|replace('-', '')|replace('_', '')|lower}}.backend_stack import {{cookiecutter.service_name|replace(' ', '')|replace('-', '')|replace('_', '')|capitalize}}Stack
